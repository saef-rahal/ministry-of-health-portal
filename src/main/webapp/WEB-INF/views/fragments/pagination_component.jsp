...
<%-- HANDLING THE PAGINATION LOGIC ON FIRST PAGES --%>
    <c:when test="${currentPage == 1 and  totalPages - currentPage >= 1 and totalPages > currentPage}">
        <li onclick="submit(this.value)" value="${1}" class="page-item not-clickable"><a href="/?page=${1}" class="page-link">First</a></li>
        <li onclick="submit(this.value)" value="${currentPage - 1}" class="page-item not-clickable"><a href="/?page=${currentPage - 1}" class="page-link">Previous</a></li>
        ...
        <c:if test="${totalPages > currentPage}">
            <li onclick="submit(this.value)" value="${currentPage + 1}" class="page-item"><a href="/?page=${currentPage + 1}" class="page-link">Next</a></li>
            <li onclick="submit(this.value)" value="${totalPages}" class="page-item"><a href="/?page=${totalPages}" class="page-link">Last</a></li>
        </c:if>
    </c:when>

<%-- HANDLING THE PAGINATION LOGIC ON THE MIDDLE PAGES --%>
<c:when test="${currentPage > 1 and currentPage < totalPages}">
        <li onclick="submit(this.value)" value="${1}" class="page-item"><a href="/page=${1}" class="page-link">First</a></li>
        <li onclick="submit(this.value)" value="${currentPage - 1}" class="page-item"><a href="/page=${currentPage - 1}" class="page-link">Previous</a></li>
...
<c:when test="${currentPage == totalPages and totalPages > 1}">
    ...
    <li onclick="submit(this.value)" value="${currentPage + 1}" class="page-item not-clickable"><a href="/?page=${currentPage + 1}" class="page-link">Next</a></li>
    <li onclick="submit(this.value)" value="${totalPages}" class="page-item not-clickable"><a href="/?page=${totalPages}" class="page-link">Last</a></li>
</c:when>
