...
<div class="wrap">
    <section>
        <div class="container">
            <div class="row">
                <form:form class="w-100 p-4 mt-5 border" action="${pageContext.request.contextPath}/inbound" method="post" modelAttribute="inbound">
                    <div class="col-12">
                        <h3>Add Inbound Request</h3>
                        ...
                        <div class="form-group col-md-4">
                            <label for="received quantity" class="col-form-label">Received Quantity</label>
                            <form:input type="number" path="receivedQuantity" class="form-control-plaintext border"/>
                        </div>
