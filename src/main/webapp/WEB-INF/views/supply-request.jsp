...
<div class="wrap">
    <section>
        <div class="container">
            <div class="row">
                <form:form class="w-100 p-4 mt-5 border" action="${pageContext.request.contextPath}/supply-request" method="post" modelAttribute="report">
                    <div class="col-12">
                        <h3>Add Supply Request</h3>
                        ...
                        <div class="form-group col-md-4">
                            <label for="received quantity" class="col-form-label">Supply Request</label>
                            <form:input type="number" path="supplyRequest" class="form-control-plaintext border"/>
                        </div>
